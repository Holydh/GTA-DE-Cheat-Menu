...
export class MainOptions {
    ...
    private _isFirstPersonControlsEnabled = getBoolean(SECTION, 'FIRST_PERSON_CAMERA');
    
    public FirstPersonControlsInitialized = false;
    ...
    private set isFirstPersonControlsEnabled(value: boolean) {
        if (this._isFirstPersonControlsEnabled === value) return;

        this._isFirstPersonControlsEnabled = value;
        saveBoolean(SECTION, 'FIRST_PERSON_CONTROLS', value);
    }
    get isFirstPersonControlsEnabled(): boolean {
        return this._isFirstPersonControlsEnabled;
    }
    ...
    renderMainOptions() {
        ...
        this.isFirstPersonControlsEnabled = ImGui.Checkbox('First person controls', this.isFirstPersonControlsEnabled);
    }
}
